...
class XD_profile extends StatelessWidget {
  XD_profile({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 343.0, 725.0),
                    size: Size(343.0, 725.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child:
                      ...
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 675.0, 343.0, 50.0),
                          size: Size(343.0, 725.0),
                          pinLeft: true,
                          pinRight: true,
                          pinBottom: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 608.0, 343.0, 50.0),
                          size: Size(343.0, 725.0),
                          pinLeft: true,
                          pinRight: true,
                          pinBottom: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 541.0, 343.0, 50.0),
                          size: Size(343.0, 725.0),
                          pinLeft: true,
                          pinRight: true,
                          fixedHeight: true,
                              ...
                              Pinned.fromSize(
                                ...
                                child:
                                  ...
                                  children: <Widget>[
                                    Pinned.fromSize(
                                      bounds:
                                          Rect.fromLTWH(0.0, 0.0, 49.0, 24.0),
                                      size: Size(49.0, 24.0),
                                      pinLeft: true,
                                      pinRight: true,
                                      pinTop: true,
                                    ...
                                    Pinned.fromSize(
                                      bounds:
                                          Rect.fromLTWH(13.0, 3.0, 24.0, 16.0),
                                      size: Size(49.0, 24.0),
                                      pinTop: true,
                                      fixedWidth: true,
                                      fixedHeight: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(111.0, 10.0, 210.0, 25.0),
                          size: Size(343.0, 725.0),
                          pinRight: true,
                          pinTop: true,
                          fixedWidth: true,
...
const String _svg_cdd3ww =
    '<svg viewBox="2782.0 -296.0 352.0 352.0" ><path transform="matrix(0.0, -1.0, 1.0, 0.0, 2782.0, 56.0)" d="M 176 0 C 273.2021179199219 0 352 78.79788208007813 352 176 C 352 273.2021179199219 273.2021179199219 352 176 352 C 78.79788208007813 352 0 273.2021179199219 0 176 C 0 78.79788208007813 78.79788208007813 0 176 0 Z" fill="#41bbae" fill-opacity="0.55" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_5dvejs =
    '<svg viewBox="16.0 162.0 343.0 170.0" ><defs><pattern id="image" patternUnits="userSpaceOnUse" width="1125.0" height="2436.0"><image xlink:href="asset/xd_to_flutter/main_background.png" x="0" y="0" width="1125.0" height="2436.0" /></pattern></defs><path transform="translate(16.0, 162.0)" d="M 4 0 L 339 0 C 341.2091369628906 0 343 1.790860891342163 343 4 L 343 166 C 343 168.2091369628906 341.2091369628906 170 339 170 L 4 170 C 1.790860891342163 170 0 168.2091369628906 0 166 L 0 4 C 0 1.790860891342163 1.790860891342163 0 4 0 Z" fill="url(#image)" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
